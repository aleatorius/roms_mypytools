...
datemin = date(1999,07,06)
datemax = date(2002,03,06)
#ymin = -2.e7
#ymax= 6.e7
...
for run in runs:
	for depth in ranges:
		...
		data0 = otime0, bio_vol0 = get_data("salt_"+run+"_arc_"+depth,1)
		print bio_vol0, run, depth
		...
		plt.plot(xotime0,bio_vol0, color)
