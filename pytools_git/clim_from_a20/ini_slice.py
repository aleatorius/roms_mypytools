...
string = """ncatted -O -a false_easting,projection_stere,o,d,"1260000" constants_sliced.nc"""
os.system(string)
string = """ncatted -O -a false_northing,projection_stere,o,d,"2170000" constants_sliced.nc"""
os.system(string)
string = """ncatted -O -a proj4,projection_stere,o,c,"+proj=stere +lat_0=90 +lon_0=58 +x_0=1260000.0 +y_0=2170000.0 +lat_ts=60 +units=m +a=6.371e+06 +e=0 +no_defs" constants_sliced.nc"""
os.system(string)
