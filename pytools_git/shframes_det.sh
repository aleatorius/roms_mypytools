...
#	if foo="$(/home/mitya/testenv/bin/python -B /home/mitya/pymframesperfile.py -o hice -v hice --var_min 0.0 --var_max 8.0 -i $file)"; then 
	if foo="$(python /home/mitya/bin/pymframesperfile.py -o detritus -v detritus --var_min 0 --var_max 2.5 -i $file )"; then 
	    echo "python works"
#	    read -a array <<< $foo
