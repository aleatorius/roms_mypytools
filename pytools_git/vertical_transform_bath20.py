...
if args.field == "u":
    array_out = vert.vert_int(inp_tr,z_ri[:,:mask_u.shape[1]],z_ro[:,:mask_u.shape[1]],undef,mask_u,mask_u,[mask_u.shape[1],mask_u.shape[0],Ni,No])
elif args.field == "v":
    array_out = vert.vert_int(inp_tr,z_ri[:mask_v.shape[0],:],z_ro[:mask_v.shape[0],:],undef,mask_v,mask_v,[mask_v.shape[1],mask_v.shape[0],Ni,No])
else:
    array_out = vert.vert_int(inp_tr,z_ri,z_ro,undef,mask_rho,mask_rho,[b[0][b[1].index("zeta")][0,:].shape[1],b[0][b[1].index("zeta")][0,:].shape[0],Ni,No])    
