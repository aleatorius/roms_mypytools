...
salinity_files = ('/global/work/apn/Arctic-4km_results/1993_2010_jens/ocean_avg_0109_1996_07_10.nc', '/global/work/apn/Arctic-4km_results/arctic20_test/ocean_avg_0118_1996_07_09.nc')
...
for hplot in [1,2]:
    ...
    for i,j in enumerate(river_num[hplot-1]):
        if abs(river_transport[hplot-1][args.num-1,i])>1000000:
            if river_transport[hplot-1][args.num-1,i]>0:
                atxt=ax.text(river_x[hplot-1][i],river_e[hplot-1][i],str(int(j))+\
                                 ...
                                 str(int(river_transport[hplot-1][args.num-1,i])), fontsize=8)
