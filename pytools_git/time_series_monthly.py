...
for year in yr:
    for month in mn:
        ...
        print listing
        time_rec = 0
        filename = "KF01_"+str(year)+str(month)+"_"+str(args.station[0])+"_"+str(args.station[1])+".nc"
...
#                u1 =f.variables["u"][counter,:,grdp[0]-1,grdp[1]]
#                u2 =f.variables["u"][counter,:,grdp[0]-1,grdp[1]-1]
#                v1 =f.variables["v"][counter,:,grdp[0],grdp[1]-1]
#                v2 =f.variables["v"][counter,:,grdp[0]-1,grdp[1]-1]
                ...
                ubar[time_rec]=f.variables["ubar"][counter,grdp[0],grdp[1]]
                vbar[time_rec]=f.variables["vbar"][counter,grdp[0],grdp[1]]
                time_var[time_rec] = t
                time_rec+=1
                print "time_rec "
                print time_rec
